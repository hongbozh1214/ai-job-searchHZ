...
### 1e. GitHub Profile
Look up the GitHub username from `documents/profile/01-candidate-profile.md`. If a GitHub URL or username is present:
...
Check `documents/profile/01-candidate-profile.md` for any other URLs (portfolio site, personal website, Kaggle, Google Scholar, ResearchGate, publication links). For each:
- Fetch the page
...
Remove anything already present in `documents/profile/01-candidate-profile.md` or `documents/profile/02-behavioral-profile.md`.
...
### Additions to `documents/profile/01-candidate-profile.md`
...
### Additions to `documents/profile/02-behavioral-profile.md`
...
### Added to documents/profile/01-candidate-profile.md
[List each competency and independent project added, with source]

### Added to documents/profile/02-behavioral-profile.md
