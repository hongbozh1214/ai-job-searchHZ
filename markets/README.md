...
The gitignored shared profile under `documents/profile/` is authoritative for
identity, experience, education, skills, and evidence. Files under
`.claude/skills/job-application-assistant/` provide tracked methodology and blank
templates only. Market overlays may define search terms, locations, language
expectations, salary display, application conventions, and deal-breakers.
